(function ($) {
  ...
  /*---------- 01. On Load Function ----------*/
    ...
    /*----------- 14. Counter Up ----------*/
    // Bind each counter once only — a second counterUp binding reads the
    // mid-animation "0" as the target and freezes the number at 0.
    $(".counter-number")
        .not("[data-counter-bound]")
        .attr("data-counter-bound", "1")
        .each(function () {
            var $el = $(this);
            if (!$el.attr("data-count")) $el.attr("data-count", $.trim($el.text()));
