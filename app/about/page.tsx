...
const milestones = [
  { year: "2012", img: "/assets/img/normal/why-1.1-1.jpg", text: "BitwiseMinds was founded by a team of passionate developers with a vision to make enterprise-grade technology accessible to every business." },
  { year: "2014", img: "/assets/img/normal/why-1.1-2.jpg", text: "Expanded our team to 20+ developers and launched our dedicated cloud solutions practice, helping 50+ businesses migrate to modern infrastructure." },
  { year: "2016", img: "/assets/img/normal/why-1.1-3.jpg", text: "Opened our UI/UX design studio, bringing award-winning design thinking to every digital product we build for our growing client base." },
  { year: "2018", img: "/assets/img/normal/why-1.1-4.jpg", text: "Delivered our 200th project milestone and introduced our flagship IT support packages, providing 24/7 managed services to SMEs across 15 countries." },
  { year: "2020", img: "/assets/img/normal/why-1.1-1.jpg", text: "Launched our Business Automation practice, helping clients save thousands of hours annually through intelligent workflow automation and AI integration." },
  { year: "2022", img: "/assets/img/normal/why-1.1-2.jpg", text: "Surpassed 400 completed projects and received the Regional IT Excellence Award for innovation in custom software development." },
  { year: "2023", img: "/assets/img/normal/why-1.1-3.jpg", text: "Grew our team to 60+ specialists and expanded into e-commerce development, helping clients generate $50M+ in online revenue." },
  { year: "2024", img: "/assets/img/normal/why-1.1-4.jpg", text: "Crossed 500+ projects delivered and established partnerships with AWS, Google Cloud, and Microsoft Azure as a certified solutions provider." },
];
            ...
            <div className="row gy-40 gx-60 align-items-center flex-row-reverse">
              <div className="col-xxl-7 align-self-center">
                <div className="img-box1" data-cue="slideInUp" data-delay="300">
                  ...
                  >
                    <Image src="/assets/img/normal/about-thumb1-1.jpg" alt="BitwiseMinds office" width={600} height={540} />
                  </div>
                </div>
              </div>
              <div className="col-xxl-5">
                <div className="title-area mb-40">
                  ...
                  <h2 className="sec-title text-anim2" data-cue="slideInLeft" data-delay="300">
                    12+ Years of Powering Digital Innovation
                  </h2>
                  <p className="fs-18 mt-4" data-cue="slideInUp">
                    Since 2012, BitwiseMinds has been at the forefront of technology — building products that solve real
                ...
                <div className="btn-wrap mt-50" data-cue="slideInUp">
                  ...
                  <div className="info-card">
                    ...
                    <div className="box-content">
                      ...
                      <p className="box-text"><a className="text-title" href="tel:001203456789">+00-(120) 3456 789</a></p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container">
          <div className="row gy-40 justify-content-center">
            {[
              ...
              { num: "60", suffix: "+", label: "Expert Developers" },
