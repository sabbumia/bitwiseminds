...
const productImages = [
  "/assets/img/product/product-website-starter-pack.png",
  "/assets/img/product/product-ecommerce-launch-bundle.png",
  "/assets/img/product/product-saas-dashboard-template.png",
  "/assets/img/product/product-react-ui-library.png",
];
            ...
            <div className="col-xl-7">
              <div className="product-single-content">
                ...
                <div className="product-quantity mb-4">
                  <div className="quantity d-flex flex-wrap align-items-center gap-3">
