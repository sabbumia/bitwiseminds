...
const comments = [
  { img: "/assets/img/blog/comment-author-daniel.jpg", name: "James Harrington", date: daysAgo(1), time: "10:30am", text: "Excellent article from the BitwiseMinds team. We recently migrated to custom software and the productivity gains have been extraordinary. The ROI was clear within 6 months.", replies: [{ img: "/assets/img/blog/comment-author-maria.jpg", name: "Rachel Thompson", date: daysAgo(1), time: "02:15pm", text: "Thank you, James! You're absolutely right — the ROI timeline really depends on the complexity of the solution, but for most mid-sized businesses we typically see positive ROI within 3–9 months." }] },
  { img: "/assets/img/blog/comment-author-chris.jpg", name: "Sophia Patel", date: daysAgo(0), time: "09:00am", text: "This perfectly captures why we switched to BitwiseMinds last year. Their automation system has saved us over 25 hours per week in manual data entry.", replies: [] },
];
            ...
            <div className="row justify-content-center">
              <div className="col-xl-10">
                <div className="title-area text-center">
                  ...
                  <h2 className="sec-title text-anim2" data-cue="slideInUp">Why Every Business Needs Custom Software in {currentYear()}: The Definitive Guide</h2>
                </div>
              </div>
            </div>
            <div className="blog-inner-img mb-55">
              <Image src="/assets/img/blog/article-developer-monitors.jpg" alt="Custom software development at BitwiseMinds" width={1100} height={550} style={{ width: "100%", height: "auto" }} />
              <div className="blog-meta">
                <Link href="/blog"><i className="fas fa-user"></i>Alex Morrison</Link>
                <Link href="/blog"><i className="fas fa-calendar"></i>{daysAgo(2)}</Link>
              </div>
            </div>
            <div className="row justify-content-center">
              <div className="col-xl-10">
                <div className="blog-content">
                  ...
                  <div className="blog-inner-img mb-40">
                    <Image src="/assets/img/blog/article-code-review.jpg" alt="Software ROI" width={900} height={450} style={{ width: "100%", height: "auto" }} />
                  </div>
