...
const initialWishlist: WishlistItem[] = [
  { id: 1, img: "/assets/img/product/product-website-starter-pack.png", title: "Business Website Starter Pack", price: "$299.00", status: "Available" },
  { id: 2, img: "/assets/img/product/product-ecommerce-launch-bundle.png", title: "E-commerce Launch Bundle", price: "$599.00", status: "Available" },
  { id: 3, img: "/assets/img/product/product-saas-dashboard-template.png", title: "SaaS Admin Dashboard Template", price: "$149.00", status: "Available" },
  { id: 4, img: "/assets/img/product/product-react-ui-library.png", title: "React UI Component Library", price: "$89.00", status: "Limited" },
];
    ...
    <main>
      ...
      <div className="space-top space-extra-bottom">
        <div className="container">
          <table className="cart_table shop_table wishlist_table">
            <thead>
              <tr>
            ...
            <tbody>
              {wishlist.map((item) => (
                <tr key={item.id} className="wishlist-item">
                  ...
                  <td className="product-price" data-title="Price"><span className="woocommerce-Price-amount">{item.price}</span></td>
                  <td className="product-stock-status" data-title="Status"><span className={item.status === "Available" ? "in-stock" : "out-of-stock"}>{item.status}</span></td>
