...
const initialCart: CartItem[] = [
  { id: 1, img: "/assets/img/product/product_1_1.png", title: "Business Website Starter Pack", price: 299.00, qty: 1 },
  { id: 2, img: "/assets/img/product/product_1_2.png", title: "E-commerce Launch Bundle", price: 599.00, qty: 1 },
  { id: 3, img: "/assets/img/product/product_1_3.png", title: "SaaS Admin Dashboard Template", price: 149.00, qty: 2 },
];
      ...
      <div className="space-top space-extra-bottom">
        <div className="container">
          <div className="woocommerce-cart-form">
            <table className="woocommerce-cart-form__contents shop_table shop_table_responsive cart">
              <thead>
                <tr>
              ...
              <tbody>
                {cart.map((item) => (
                  <tr key={item.id} className="woocommerce-cart-form__cart-item cart_item">
                    ...
                    <td className="product-price"><span className="woocommerce-Price-amount">${item.price.toFixed(2)}</span></td>
                    ...
                    <td className="product-subtotal"><span className="woocommerce-Price-amount">${(item.price * item.qty).toFixed(2)}</span></td>
                  </tr>
                ))}
                <tr>
                  <td colSpan={6}>
                    <div className="actions d-flex justify-content-between align-items-center">
                      <div className="coupon d-flex gap-2"><input type="text" className="input-text" placeholder="Coupon code" /><button className="th-btn style-border" type="button">Apply Coupon</button></div>
