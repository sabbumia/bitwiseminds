        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              ...
              <hr />
              <p className="fs-18">BitwiseMinds has been building innovative software and delivering reliable IT solutions since 2025. To us, your business isn&apos;t just a client — it&apos;s a long-term partnership.</p>
              <p>Our team of 4+ expert developers, designers, and strategists works with businesses of all sizes to deliver technology that drives measurable results.</p>
              <hr />
              <div className="mb-4">
