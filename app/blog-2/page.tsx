...
const posts = [
  { img: "/assets/img/blog/custom-software-sidebar.jpg", title: `Why Every Business Needs Custom Software in ${currentYear()}`, date: daysAgo(0), author: "Alex Morrison" },
  { img: "/assets/img/blog/it-support-partner.jpg", title: "How to Choose the Right IT Support Partner", date: daysAgo(6), author: "Laura Chen" },
  { img: "/assets/img/blog/cloud-vs-onpremise.jpg", title: "Cloud vs On-Premise: Which Is Right for Your Business?", date: daysAgo(12), author: "Rachel Thompson" },
];

const recentPosts = [
  { img: "/assets/img/blog/custom-software-business.jpg", title: "Custom Software vs Off-the-Shelf", date: daysAgo(0) },
  { img: "/assets/img/blog/cloud-migration-guide.jpg", title: "Cloud Migration Checklist for SMEs", date: daysAgo(6) },
  { img: "/assets/img/blog/business-automation-savings.jpg", title: "10 Signs Your Business Needs Automation", date: daysAgo(12) },
];
