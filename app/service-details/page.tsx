            ...
            <div className="col-xl-8 col-lg-7">
              <div className="page-single">
                <div className="page-img gsap-parallax mb-25">
                  <Image src="/assets/img/service/service-s-1-1.jpg" alt="Website Design & Development" width={800} height={480} />
                ...
                <div className="page-img-wrap mt-40">
                  <div className="row">
                    <div className="col-md-6"><div className="page-img radius-20"><Image src="/assets/img/service/service-s-1-2.jpg" alt="Development process" width={380} height={260} /></div></div>
                    <div className="col-md-6"><div className="page-img radius-20"><Image src="/assets/img/service/service-s-1-3.jpg" alt="Design system" width={380} height={260} /></div></div>
                  </div>
                </div>
              ...
              <aside className="sidebar-area sidebar-sticky rounded-0 p-0 bg-transparent">
                ...
                <div className="widget widget_banner" style={{ backgroundImage: "url(/assets/img/widget/widget-banner.png)" }}>
                  <div className="widget-banner text-center">
                    ...
                    <h5 className="link"><a href="tel:001203456789">+00-(120) 3456 789</a></h5>
