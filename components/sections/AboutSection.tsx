          ...
          <div className="row gy-40 gx-60 align-items-center flex-row-reverse">
            <div className="col-xxl-7 align-self-center">
              <div className="img-box1" data-cue="slideInUp" data-delay="300">
                ...
                >
                  <Image src="/assets/img/normal/about-thumb1-1.jpg" alt="BitwiseMinds team at work" width={600} height={540} />
                </div>
            ...
            <div className="col-xxl-5">
              <div className="title-area mb-40">
                ...
                <p className="fs-18 mt-4" data-cue="slideInUp">
                  For over 12 years, BitwiseMinds has been building innovative software and delivering reliable IT
                ...
                <div className="info-card">
                  ...
                  <div className="box-content">
                    ...
                    <p className="box-text">
                      <a className="text-title" href="tel:001203456789">+00-(120) 3456 789</a>
                    </p>
                  </div>
                </div>
              </div>
