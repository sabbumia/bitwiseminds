...
export default function AppointmentSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        setStatus("success");
        setFormData({ name: "", email: "", company: "", subject: "", date: "2025-11-16" });
      } else {
        setStatus("error");
      }
    } catch {
        ...
        <div className="row gy-40 align-items-center flex-row-reverse">
          ...
          <div className="col-xl-5">
            <div className="appointment-thumb-1-1 pe-xl-5 me-xl-3" data-cue="slideInUp">
              <Image src="/assets/img/appointment/appointment-1-1.png" alt="Book a consultation" width={420} height={500} />
            </div>
          </div>
        </div>
      </div>
