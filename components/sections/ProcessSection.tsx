          ...
          <div className="col-xl-6">
            <div className="process-slide-image">
              <div
                ...
                data-bg-src="/assets/img/process/process-discovery-consultation.jpg"
                style={{ backgroundImage: "url(/assets/img/process/process-discovery-consultation.jpg)" }}
              ></div>
              <div
                className="img foreground-img"
                data-bg-src="/assets/img/process/process-development-deployment.jpg"
                style={{ backgroundImage: "url(/assets/img/process/process-development-deployment.jpg)" }}
              ></div>
              <input
                type="range"
                min="1"
