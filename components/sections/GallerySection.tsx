...
const portfolioItems = [
  { img: "/assets/img/gallery/gallery_1_1.jpg", label: "E-commerce Platform" },
  { img: "/assets/img/gallery/gallery_1_2.jpg", label: "SaaS Dashboard" },
  { img: "/assets/img/gallery/gallery_1_3.jpg", label: "Mobile App" },
  { img: "/assets/img/gallery/gallery_1_4.jpg", label: "Corporate Website" },
  { img: "/assets/img/gallery/gallery_1_5.jpg", label: "ERP System" },
  { img: "/assets/img/gallery/gallery_1_6.jpg", label: "Cloud Infrastructure" },
];
