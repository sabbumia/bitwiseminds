...
const slides = [
  { bg: "/assets/img/hero/hero-slide-it-team.jpg" },
  { bg: "/assets/img/hero/hero-slide-software-code.jpg" },
  { bg: "/assets/img/hero/hero-slide-digital-network.jpg" },
];
  ...
  return (
    <div className="th-hero-wrapper hero-1" id="hero">
      ...
      <div className="circle-tag scroll-down">
        <span className="circle-title-anime">*** TRUSTED BY 6+ BUSINESSES WORLDWIDE</span>
      ...
      <div className="client-group-wrap">
        <div className="thumb">
          <Image src="/assets/img/normal/client-avatars-group.png" alt="Avatars of satisfied BitwiseMinds clients" width={120} height={40} />
        </div>
        <div className="box-content">
          <div className="star-rating"></div>
          <div className="box-text">4.9 rating based on 6+ client reviews</div>
        </div>
      </div>

      <div className="hero-counter-wrap">
        <div className="counter-card">
          <h2 className="box-number"><span className="counter-number">6</span>+</h2>
          <p className="box-text">Projects</p>
        </div>
        <div className="counter-card">
          <h2 className="box-number"><span className="counter-number">4</span>+</h2>
          <p className="box-text">Experts</p>
        </div>
        <div className="counter-card">
          <h2 className="box-number"><span className="counter-number">6</span>+</h2>
